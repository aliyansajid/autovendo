...
export function BasicDataSection() {
  ...
  const vehicleDataMap: Record<string, { makes: unknown; models: unknown; bodyTypes: readonly { value: string; label: string }[]; fuelTypes: readonly { value: string; label: string }[] }> = {
    CAR: {
      makes: carMakes,
      models: carModels,
  ...
  const activeModels = vehicleData.models as Record<string, { value: string; label: string }[]>;
