...
export default async function ListingPage({
  ...
  const seller = isDealer
    ? {
        ...
        isVerified: item.dealer.user?.emailVerified === true,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardContent className="grid grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <KeyDetailCard
                ...
                label={t("sellerType")}
                value={isDealer ? t("dealer") : t("privateSeller")}
              />
            </CardContent>
          </Card>
          ...
          <div className="space-y-6">
            ...
            {isDealer && seller && <SellerSection seller={seller} />}

            {isDealer && seller && seller.rating != null && (
              <ReviewSection
