        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          <View style={styles.successContent}>
            ...
            <Text style={styles.successHint}>
              ...
              <Text style={styles.resendLink} onPress={() => setSent(false)}>
                try again
              </Text>
              .
            </Text>
              ...
              <View style={styles.fieldGroup}>
                ...
                <View style={[styles.inputWrapper, emailFocused && styles.inputWrapperFocused]}>
                  ...
                  <TextInput
                    ...
                    autoCorrect={false}
                    returnKeyType="send"
                    onSubmitEditing={() => email.length > 0 && setSent(true)}
                  />
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  safeArea: { flex: 1, paddingHorizontal: Spacing[6] },
  keyboardView: { flex: 1 },
  inner: { flex: 1, paddingBottom: Spacing[8] },
