...
export default function DealerNewListing() {
  const C = useTheme();
  return (
    <View style={[styles.root, { backgroundColor: C.background }]}>
      ...
      <View style={styles.body}>
        ...
        <Text style={[styles.text, { color: C.mutedForeground }]}>
          Das native Erstellen von Inseraten wird gerade fertiggestellt. In der Zwischenzeit können Sie Fahrzeuge
          auf autovendo.ch erfassen.
        </Text>
        <Button
          label="Auf autovendo.ch erstellen"
          icon="safari.fill"
          onPress={() => openUrl("https://seller.autovendo.ch/de/dealer/vehicles/new")}
          size="lg"
          fullWidth
