...
// Colors converted from the web app's OKLCH design tokens (packages/ui/src/styles/globals.css)
export const Colors = {
  light: {
    background: '#ffffff',
    foreground: '#111118',
...
// Geist fonts — load in _layout.tsx via expo-font using assets/fonts/Geist*.ttf
